...
// Get service account credentials from file for development
let serviceAccount;
try {
    serviceAccount = require('../serviceAccountKey.json');
} catch (error) {
    console.error("Service account file not found. Attempting to use environment variables.");

    // Fallback to environment variables or use dummy values for development
    serviceAccount = {
...
const app = initializeApp({
    ...
    storageBucket: "gestureconnect-8aa03.appspot.com"
});
