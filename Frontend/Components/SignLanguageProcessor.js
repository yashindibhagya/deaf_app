            ...
            <View style={styles.loadingContainer}>
                ...
                {Platform.OS === 'android' ? (
                    <ProgressBarAndroid
                        ...
                        indeterminate={modelLoadingProgress === 0}
                ...
                <Text style={styles.progressText}>{modelLoadingProgress}%</Text>

                {modelLoadingError && (
                    <Text style={styles.errorText}>Error: {modelLoadingError}</Text>
                )}
            </View>
        );
    };
